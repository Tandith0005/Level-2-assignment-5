...
import { useEventAction } from "@/src/hooks/useEventAction";
import ReviewSection from "@/src/components/event/ReviewSection";
...
export default function EventDetailsPage() {
  ...
  const eventData = event?.data || event || null;
  ...
  const {
    ...
    isProcessing,
    handleMainAction,
  } = useEventAction(eventId, eventData, user?.id, isAuthenticated);
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen pt-24 flex flex-col items-center justify-center">
        ...
        <p className="text-violet-400 mt-4 animate-pulse">Loading event details...</p>
      </div>
    );
  }
        ...
        <div className="bg-[#111118]/90 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="w-full md:w-auto flex flex-col items-center gap-3">
                {actionConfig && (
                  <button
                    ...
                    disabled={actionConfig.disabled || isProcessing}
                ...
                {hasPendingPayment && paymentStep === "idle" && (
                  <div className="text-center">
                    ...
                    <p className="text-amber-300/70 text-xs mt-1">
                      Click &quot;Complete Payment&quot; to finish your registration.
                    </p>
                  </div>
                )}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3">
            ...
            <div className="lg:col-span-2 p-6 sm:p-8 border-r border-white/5">
              ...
              <ReviewSection eventId={eventId} isParticipant={isParticipant} />
            </div>
            ...
            <div className="bg-gradient-to-b from-[#0d0d14] to-[#0a0a0f] p-6 sm:p-8 space-y-6">
              ...
              <div className="space-y-4">
                {sidebarDetails.map(({ icon: Icon, label, main, sub }) => (
